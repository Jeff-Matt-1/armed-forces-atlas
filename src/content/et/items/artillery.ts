...
export const etArtillery: Record<string, ItemTranslation> = {
  "d-30": {
    ...
    doctrineNote:
      "Odavaim viis patarei välja panna. Grau ja Bartles kirjeldavad süsteemi, kus tulemaht loeb rohkem kui täpsus. D-30 on olemas selleks, et torusid juurde anda.",
    crew: "6",
    service: "Kasutuses",
  },
  "2a65-msta-b": {
