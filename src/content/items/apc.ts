...
export const apc: Item[] = [
  ...
  },
  {
    ...
    armament: "7.62 mm PKT in a small turret; 12.7 mm NSVT or Kord on the VM variants",
    rangeText: null,
    cues: [
      "Tracked and remarkably low — barely taller than the men beside it",
      "Long flat roof with almost no superstructure",
      "Turret at the front right: a small 7.62 mm one, a bulkier 12.7 mm mount, or none",
    ...
    placements: [
      ...
      "Infantry carrier in motor rifle units",
    ],
    doctrineNote:
      "More chassis than vehicle: the hull underneath the 2S1 and a dozen specialist conversions. Identifying one tells you little until you read what has been bolted to its roof — wide tracks for snow and soft ground on the V variants, a 12.7 mm mount on the VM and VMK, and infantry in the back as a matter of routine rather than improvisation.",
    crew: "2 + 11",
    service: "In service",
    sort: 4,
  },
