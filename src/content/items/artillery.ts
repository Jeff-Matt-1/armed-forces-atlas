...
export const artillery: Item[] = [
  ...
  {
    slug: "2a36-giatsint-b",
    blockSlug: "artillery",
    name: "2A36 Giatsint-B",
    aka: "Hyacinth",
    imageUrl: "/images/items/2a36-giatsint-b.jpg",
    imageCredit: "CC BY-SA 4.0 — Mike1979 Russia",
    imagePage: "https://commons.wikimedia.org/wiki/File:152_mm_Gun_2A36_Giatsint-B_2017-12-24.JPG",
    armament: "152 mm 2A36 gun",
    rangeText: "Roughly 28 km, further with rocket assistance",
    cues: [
      "Very long thin barrel — the longest on any towed Russian gun",
      "Multi-baffle muzzle brake at the end of that barrel",
      "Split trails with a small auxiliary power unit on the carriage",
      "No shield, unlike the D-30 and the Msta-B",
    ],
    placements: [
      "Gun artillery of army-level artillery brigades",
      "Sited well back, reaching targets other towed guns cannot",
    ],
    doctrineNote:
      "A gun rather than a howitzer: flat trajectory, long reach, and used for counter-battery and deep targets instead of supporting an attack directly. Finding one says the fires being planned belong to an army rather than to a brigade.",
    crew: "8",
    service: "In service",
    sort: 12,
  },
  {
    ...
    name: "2S31 Vena",
    aka: "Vienna",
    imageUrl: "/images/items/2s31-vena.jpg",
    imageCredit: "CC BY-SA 4.0 — Vitaly V. Kuzmin",
    imagePage: "https://commons.wikimedia.org/wiki/File:2S31_Vena_Sideview.jpg",
    armament: "120 mm 2A80 gun-mortar",
    rangeText: "Roughly 13 km with a rocket-assisted shell",
    cues: [
      "BMP-3 hull carrying a large rounded turret with a short fat barrel",
      "Barrel far stubbier than any tank gun on a similar hull",
      "Turret sits high and well back on the deck",
      "Amphibious, with the BMP-3 water jets at the rear",
    ],
    placements: [
      "Self-propelled mortar batteries of airborne and naval infantry units",
      "Fires from within the manoeuvre unit rather than from a gun line behind it",
    ],
    doctrineNote:
      "A Nona's job in a turret on a fighting vehicle's hull: mortar, howitzer and direct fire from a vehicle that keeps up with the infantry it supports. Its presence means a unit carries its own indirect fire rather than calling for it.",
    crew: "4",
    service: "In service",
    sort: 13,
  },
  {
    ...
    cues: [
      "BTR-D hull — tracked, low, with six small roadwheels",
      "Small turret carrying a very short fat barrel",
      "Barrel elevates far higher than any tank or assault gun",
      "Air-droppable and amphibious, unlike the 2S31 on its BMP-3 hull",
    ],
    placements: [
      "Self-propelled artillery batteries of airborne regiments",
      "The airborne answer to a howitzer battery, dropped with the force",
    ],
    doctrineNote:
      "The gun-mortar the Nona-K tows, put on a hull light enough to parachute. It gives an airborne regiment its own indirect fire from the moment it lands, which is the difference between holding an objective and merely reaching it.",
    crew: "4",
    service: "In service",
    sort: 14,
  },
  {
    ...
    name: "2S4 Tyulpan",
    aka: "Tulip",
    imageUrl: "/images/items/2s4-tyulpan.jpg",
    imageCredit: "CC BY-SA 3.0 — Dmitry A. Mottl",
    imagePage: "https://commons.wikimedia.org/wiki/File:2S4_Tyulpan.jpg",
    armament: "240 mm 2B8 mortar",
    rangeText: "Roughly 9.6 km, about 20 km with a rocket-assisted bomb",
    cues: [
      "Enormous mortar barrel carried folded along the rear deck, not in a turret",
      "Barrel swings down and back to fire from a baseplate on the ground",
      "Tracked hull with no turret at all, close to the 2S7 in size",
      "Bombs are man-high and loaded from a rack at the rear",
    ],
    placements: [
      "Heavy mortar batteries held at army level",
      "Committed against fortifications rather than in support of an attack",
    ],
    doctrineNote:
      "The largest mortar in service anywhere, and it is not there for troops in the open: it is for buildings, bunkers and prepared positions that a howitzer will not break. Seeing one says a deliberate attack on fortified ground is being prepared, and that the decision was taken well above the unit in contact.",
    crew: "5",
    service: "In service",
    sort: 15,
  },
